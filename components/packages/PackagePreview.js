    ...
    <div className="flex flex-col h-full">
      ...
      >
        ...
        <div className="text-center pb-5 border-b-2 border-brand mb-5">
          <p className="text-brand font-bold text-base">🏔 Tripcart Holidays</p>
        ...
        <div className="mt-6 pt-4 border-t border-slate-100 text-center">
          <p className="text-xs text-slate-400">Generated by Tripcart Holidays · tripcartholidays.com</p>
        </div>
      </div>
    </div>
  )
